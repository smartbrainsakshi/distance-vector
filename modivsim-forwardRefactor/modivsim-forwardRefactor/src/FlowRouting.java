...
public class FlowRouting {
    ...
    private static void readFlows() throws IOException{ // reads flows from the text flows.txt
        ...
        String filePath = "F:\\Geeko\\Distance-Vector-Routing-and-Flow-Control-Simulator-main\\Distance-Vector-Routing-and-Flow-Control-Simulator-main\\modivsim-forwardRefactor\\modivsim-forwardRefactor\\src\\FlowRoutingFolder\\flows.txt";
    ...
    private static List<ArrayList<Integer>> readForwardingTable() throws IOException{
        ...
        BufferedReader reader;
        String filePath = "F:\\Geeko\\Distance-Vector-Routing-and-Flow-Control-Simulator-main\\Distance-Vector-Routing-and-Flow-Control-Simulator-main\\modivsim-forwardRefactor\\modivsim-forwardRefactor\\src\\FlowRoutingFolder\\forwardingTable.txt";
        reader = new BufferedReader(new FileReader(filePath));
        try{
        String line = reader.readLine();
